...
***            Webdemo.exe "config"
***            Webdemo.exe "config" "IIS://localhost/w3svc/21/root"
************************************************************************
...
IF VARTYPE(lcAction) = "C" AND StartsWith(LOWER(lcAction),"config")
         do Webdemo_ServerConfig.prg with lvParm1
      RETURN 
ENDIF

*** Load the server - wc3DemoServer class below
goWCServer = CREATE("WebdemoServer")
...
IF llAutoRestart
   LiveReloadShutdown("DO WebdemoMain.prg")
ELSE
...
*** THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Webdemo.ini"

THIS.cAppName = "Webdemo"
THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Webdemo.ini"
...
THIS.oConfig = CREATEOBJECT("WebdemoConfig")
...
***************************************************************
DEFINE CLASS WebdemoConfig AS wwServerConfig
***************************************************************
*: Author: Rick Strahl
...
THIS.oWebProcess = CREATEOBJECT("WebProcessConfig")
...
cHTMLPagePath = "c:\WebConnectionProjects\WebDemo\Web\"
cDATAPath = ".\"
cVirtualPath = "/WebDemo/"

ENDDEFINE



*** Configuration class for the WebProcess Process class
DEFINE CLASS WebProcessConfig as wwConfig
